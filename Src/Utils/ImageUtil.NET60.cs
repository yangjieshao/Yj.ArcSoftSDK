...
namespace Yj.ArcSoftSDK._4_0.Utils
{
    ...
    public static class ImageUtil
    {
        ...
        public static ASVL_OFFSCREEN GetImageData(SKBitmap inImage)
        {
            ...
            result.i32Width = inImage.Width;
            result.i32Height = inImage.Height;
            result.pi32Pitch[0] = inImage.Width * 3;// data.Width * 3;

            byte[] sourceBitArray = inImage.Bytes;
            byte[] destBitArray = new byte[inImage.Width * inImage.Height * 3];
        ...
        public static ASVL_OFFSCREEN GetImageData_IR(SKBitmap inImage)
        {
            ...
            byte[] sourceBitArray = inImage.Bytes;
            byte[] destBitArray = new byte[inImage.Width * inImage.Height];
        ...
        public static ImageInfo ReadBMP(SKBitmap image)
        {
            ...
            try
            {
                ...
                byte[] sourceBitArray = image.Bytes;
                byte[] destBitArray = new byte[image.Width * image.Height * 3];
        ...
        public static ImageInfo ReadBMP_IR(SKBitmap image)
        {
            ...
            try
            {
                ...
                byte[] sourceBitArray = image.Bytes;
                byte[] destBitArray = new byte[image.Width * image.Height];
