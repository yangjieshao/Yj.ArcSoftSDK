...
namespace Yj.ArcSoftSDK._4_0
{
    ...
    /// SDK中与人脸识别相关函数封装类
    /// </summary>
    internal static partial class ASFFunctions_Pro_Win
    {
        /// <summary>
        /// 采集当前设备信息
        /// </summary>
        ...
        /// <returns>调用结果</returns>
        [LibraryImport(Dll_PATH, SetLastError = true)]
        internal static partial int ASFInitEngine(uint detectMode, int detectFaceOrientPriority, int detectFaceMaxNum, int combinedMask, ref IntPtr pEngine);
        ...
        /// <returns>调用结果</returns>
        [LibraryImport(Dll_PATH, SetLastError = true)]
        internal static partial int ASFImageQualityDetectEx(IntPtr pEngine, IntPtr imgData, IntPtr faceInfo, int isMask, ref float confidenceLevel, int detectModel);
        ...
        /// <returns></returns>
        [LibraryImport(Dll_PATH, SetLastError = true)]
        internal static partial int ASFSetFaceShelterParam(IntPtr pEngine, float shelterThreshhold);
        ...
        /// <returns></returns>
        [LibraryImport(Dll_PATH, SetLastError = true)]
        internal static partial int ASFGetFaceLandMark(IntPtr pEngine, IntPtr landMarkInfo);
    }
}
#endif